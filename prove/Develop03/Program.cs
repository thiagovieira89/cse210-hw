...
class Program
{
    static void Main(string[] args)
    {
        ...
        while (answer != "quit")
        {
            ...
            Word text = new Word(" For God so loved the world, that he gave his only begotten Son, that whosoever believeth in him should not perish, but have heverlasting life.");
